...
function lI1Ia()
{
 ...
 for(var i=0;(i<menuItems.length&&typeof(menuItems[i])!="undefined");i++){II1l=0;while(menuItems[i][0].charAt(II1l)=="|")II1l++;
 if(II1l>0)menuItems[i][0]=menuItems[i][0].substring(II1l,menuItems[i][0].length);
