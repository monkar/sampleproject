...
<table width="100%" class="2" cellspacing="0" cellpadding="0">
      ...
      <td>
        ...
        <tr>
            ...
            <%if (true || (usuario.getIntIdRol()!=Constante.NROLMED && usuario.getIntIdRol()!=Constante.NROLATEC)){%>
                ...
                <td align=left width="25%" class="row1" >
                    <select name="lscEstado" <%=(usuario.getIntIdRol()!=Constante.NROPERFILBRK && usuario.getIntIdRol()!=Constante.NROLOPE && usuario.getIntIdRol()!=Constante.NROLENF)?"multiple class='TxtCombo lp-select-multiple'":"class='TxtCombo lp-select'"%> style="width:180px;height:70px;">
    ...
    <tr id="trBusqueda" style="display=''">
      <td>
        ...
        <%
         ...
         {
        %>
          <iframe name="frLstSolicitud" align=left width="100%" height="900px" frameborder="0" scrolling="auto" src="../avisogerencia/ListaSolicitud.jsp?psbuscar=1&default=1"></iframe>        
        <%
         }else{
        %>  
          <iframe name="frLstSolicitud" align=left width="100%" height="900px" frameborder="0" scrolling="auto" src="../avisogerencia/ListaSolicitud.jsp?psbuscar=0&default=1"></iframe>
        <%
         }        
        %>  
        </fieldset>
 ...
 <tr id="dtSolicitud"  style="display:none">
  ...
  <table cellSpacing="0" class="2" border=0 width="100%" align="left" >
    <tr >
      <td> 
        <iframe name="procsolicitud" frameborder="0" height="900px" width="100%" scrolling="auto" src="../blancos.html"></iframe>  
      </td>
    </tr>
  </table>
 </td>
...
<script type="text/javascript">
  function verListado(){
      ...
      frLstSolicitud.location.href = "../avisogerencia/ListaSolicitud.jsp";    
  }
  ...
  function buscar(optBusqueda)
  {
     if(optBusqueda == 1)
     {
        ...
        if(flg == 1)
        {
          ...
          frm.action="../avisogerencia/ListaSolicitud.jsp?psbuscar=1&default=0";        
          frm.submit(); 
        }
        else
        {
    ...
    {
      window.scrollTo(0,0);
      window.location.href = "../avisogerencia/Bandeja.jsp";
    }
  }
