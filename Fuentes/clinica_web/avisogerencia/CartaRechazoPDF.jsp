...
<%
    ...
    Poliza objPoliza = gestorPolClinic.getPoliza(Constante.NRAMOASME,objCliente.getIntPoliza(),0);
  ...
  //}
    ...
    cell = ToolPdf.makeCell((objSolicitud.getIntCodOficina()==23?"San Isidro":objSolicitud.getStrNombOficina()) +  ", " + strDia + " de " + strMesActu + " de " + strAnio , Element.ALIGN_TOP, Element.ALIGN_LEFT, tableFont, tableFont.size() * 1.2f, 2f, border, true, true);
    table.addCell(cell);
    cell = ToolPdf.makeCell("SNTROS.RCH N°: " + strNroCartaRechazo, Element.ALIGN_TOP, Element.ALIGN_RIGHT, FontFactory.getFont("Calibri", 10), tableFont.size() * 1.2f, 2f, border, true, true);
    table.addCell(cell);
