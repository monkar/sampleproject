...
<% 
    ...
    objList = gestorAlerta.listAlerta(nMontoMinimo, nMontoMaximo);
...
<LINK REL=Stylesheet TYPE="text/css" HREF="../styles/IntraStyles.css?v=1.0.0.1">
                    ...
                    <table width="100%"  class="2 table_principal gris_pares table_pagination"> 
                        ...
                        %>
                              <tr>
                                ...
                                <td class="row1" align="center"><%=objBean.getString("NIDALERTA")%></td>
                                <td class="row1" align="center"><%=objBean.getString("SDESCRIPCION")%></td>
                                ...
                                <td class="row1 tr-td-last-child" align="center">
                                    <A class="link_acciones" href="javascript:Editar('<%=objBean.getString("NIDALERTA")%>','<%=objBean.getString("SDESCRIPCION")%>','<%=objBean.getString("NMONTOMAX")%>','<%=objBean.getString("NMONTOMIN")%>','<%=objBean.getString("NESTADO")%>');">
  ...
  <script type="text/javascript">
      ...
      function Editar(idalerta, sDescripcion, nMontoMaximo, nMontoMinimo, nEstado)
      {
          parent.Editar(idalerta, sDescripcion, nMontoMaximo, nMontoMinimo, nEstado); 
      }
