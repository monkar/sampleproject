...
<% 
    ...
    int intOficina =  (request.getParameter("lscOficina")!=null?Tool.parseInt(request.getParameter("lscOficina")):0);
    ...
    objList = gestorZonaOficina.listZonaOficina(intZona, intOficina);
...
%>
  ...
  <![endif]--> 
  <form name="frmListaZonaOficina" method="post">   
                ...
                <td class="row1" width="100%" align="left" colspan="2"> 
                    <table width="100%"  class="2 table_principal gris_pares table_pagination"> 
                        <tr>
                            ...
                            <th class="header" align=center WIDTH=10%>Oficina</th>
                        ...
                        %>
                              <tr>
                                ...
                                <td class="row1" align="center"><%=objBean.getString("SNOMBRE")%></td>
                                <td class="row1" align="center"><%=objBean.getString("DESCRIPCION")%></td>
                                <td class="row1" align="center"><%=objBean.getString("ESTADO")%></td>
                                <td class="row1 tr-td-last-child" align="center">
                                    <A class="link_acciones" href="javascript:Editar('<%=objBean.getString("NIDZONA")%>','<%=objBean.getString("CODOFICINA")%>','<%=objBean.getString("NACTIVO")%>');">
  ...
  <script type="text/javascript">
      ...
      {
          parent.Editar(idzona, idoficina, idactivo); 
      }
