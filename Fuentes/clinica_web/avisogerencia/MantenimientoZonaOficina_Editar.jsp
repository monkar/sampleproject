...
<%   
      String strTitulo = "Configuración de Zona Oficina";
      String strSubTitulo = "Nuevo";
      int intZona =  (request.getParameter("nZona")!=null?Tool.parseInt(request.getParameter("nZona")):0);
      int intOficina =  (request.getParameter("nOficina")!=null?Tool.parseInt(request.getParameter("nOficina")):0);
  ...
  <head>
    ...
    { 
         ...
         <%if(intFlgEdit==0){%>
              ...
              frm.lscOficina.disabled=true;
              frm.lscZona.value = <%=intZona%>;
              frm.lscOficina.value = <%=intOficina%>;
              if(<%=intEstado%>==1)
    ...
    {
        var frm = document.forms[0]; 
        window.location.href = "../avisogerencia/MantenimientoZonaOficina.jsp"; 
    }
    ...
    { 
        ...
        var nOficina = frm.lscOficina.value;
        var nEstado = 0;
        if(frm.chcEstado.checked==true)
            nEstado=1;
       
        frm.target="proceso";
        frm.action="../servlet/ProcesoMant?proceso=7&hctAcc="+ hctAcc +"&nZona=" + nZona + "&nOficina=" + nOficina + "&nEstado=" + nEstado;
        frm.submit();
    ...
    { 
        ...
        if (valor == -2)
            alert("No se puede registrar la configuración. Existe una configuración para la Zona y Oficina seleccionada.");   
        if (valor == -3)
            alert("No se puede actualizar la configuración. No existe una configuración para los datos ingresados.");
        if (valor == -4)
            alert("No se puede registrar la configuración. La Oficina se encuentra asignada a otra Zona.");
        if (valor == -5)
                    ...
                    <table cellSpacing="1"  border=0 width="100%">
                        <tr>
                            <td colspan=2 class="row7 titulo_campos_bold" style="FONT-SIZE: 10pt" align="left">
                              <%=strSubTitulo%>&nbsp;-&nbsp;Configuraci&oacute;n&nbsp;de&nbsp;Zona/Oficina
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr> 
                            ...
                            <td class="row1">
                                <select class="TxtCombo lp-select" style="width:30%" name="lscZona">
                        ...
                        <tr>
                            <td class="header" width="10%">Oficina</td>
                            <td class="row1">
                                <select class="TxtCombo lp-select" style="width:30%" name="lscOficina">
                                    <option value=0>(Seleccione)</option>
