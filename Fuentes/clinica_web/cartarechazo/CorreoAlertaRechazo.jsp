  ...
  <table width="100%" class="2" cellspacing="0" cellpadding="0">
    <tr>
      <td>
        ...
        <legend class="titulo_campos_bold">Correo Alerta Carta Rechazo Carta</legend>  
        <table cellSpacing="1"  border=0 width="100%" class="form-table-controls">
        <tr>
            <td align=left class="row1"  width="15%">Correo Rechazo :&nbsp;</td>
                ...
                <td align=left width="25%" class="row1" >
                    <select class="TxtCombo lp-select" style="width:250px;height:200px;" name="lscCorreoCC" multiple>
                        <%BeanList objLista = new BeanList();
                          ...
                          objLista = Tool.obtieneLista("SELECT IDEMAIL, SEMAIL FROM PTBLCORREORECHAZO WHERE NTIPOC = 1 AND NESTADOC=1","");
                          out.println(Tool.listaCombo(objLista,"IDEMAIL","SEMAIL"));
                        %>  
                    </select>
...
{                                                                          
    ...
    {
      frmMantCorreoAvisoGerencia.action="../servlet/ProcesoMant?proceso=12&hctAcc=" + option + "&idcorreo=" + idcorreo + "&correo=" + correo;
