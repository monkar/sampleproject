...
<html>
  <head>
    ...
    <title>CONFIGURACION DE MONTOS ALERTA</title>
    ...
    <script type="text/javascript">
        ...
        function Buscar(pagina)
        {
            ...
            accion = "ListaMontoAlerta.jsp?flgBuscar=1";
            if (pagina != undefined)
        ...
        { 
           var frm = document.forms[0]; 
           frm.target = "_self";
           frm.action = "MantenimientoAlertaRechazo_Editar.jsp";
           frm.submit(); 
        }
        
        
        function Editar(idAlerta, sDescripcion,sCargo, nMontoMax, nMontoMin, idEstado)
        { 
           var frm = document.forms[0]; 
           frm.target = "_self";
           frm.action = "MantenimientoAlertaRechazo_Editar.jsp?nAlerta=" + idAlerta + "&sDescripcion=" + sDescripcion.replace("'", "")+  "&sCargo=" + sCargo.replace("'", "") + "&nMontoMax=" + nMontoMax + "&nMontoMin=" + nMontoMin + "&nEstado=" + idEstado;
           frm.submit(); 
        }      
            ...
            <table width="100%" class="2 form-table-controls" cellspacing="0" cellpadding="0">
                        ...
                        <fieldset class="row5 content_resumen">
                            ...
                            <table cellSpacing="1" border=0 width="100%">
                                ...
                                <tr>
                                    ...
                                    <td  width="25%" class="row5" align="left" >                                   
                                        <input class="row5 input_text_sed" name = "tctEncargado" type="text" maxlength="150" style="width:100%" value="" >
                                    </td>
                                    <td  width="6%" class="row5" align="left">
                                        Cargo:&nbsp;
                                    </td>
                                    <td width="25%" class="row5"  align="left" colspan="2">
                                        <input class="row5 input_text_sed" name = "tctCargo" type="text" maxlength="150" style="width:100%" value="" >
                                    </td>
                                    <td width="25%" class="row5" align="left" colspan="2"></td>
                                    <!--<td  width="25%" class="row5" align="left" colspan="2">
                                        <A href="javascript:Buscar()">
                                            <IMG alt=Buscar src="../images/btn_Buscar.gif" border=0>
                                        </A>
                                    </td>-->
                                </tr>
                                <tr>
                ...
                <tr id="trBusqueda" style="display:none">
                    <td>
                        <fieldset class="row5 content_resumen">
                        <legend></legend>  
                            <iframe name="frLstAlerta" align=left width="100%" height="700" frameborder="0" scrolling="auto" src="ListaMontoAlerta.jsp"></iframe>
                        </fieldset>
                    </td>
                </tr>
            </table>      
