...
<%   
      ...
      String sEncargado = (request.getParameter("sDescripcion")!=null?(request.getParameter("sDescripcion").toString()):"");
  ...
  <head>
    ...
    { 
         ...
         <%if(intFlgEdit==0){%>
              ...
              frm.tctDescripcion.value= '<%=sEncargado%>';
    ...
    {
        var frm = document.forms[0]; 
        window.location.href = "../cartarechazo/MantenimientoAlertaRechazo.jsp"; 
    }
    ...
    { 
        ...
        var sCargo = frm.tctCargo.value.replace("'", "");
        ...
        frm.target="proceso";
        frm.action="../servlet/ProcesoMant?proceso=13&hctAcc="+ hctAcc +"&nAlerta=" + nAlerta + "&sDesc=" + sDescripcion + "&sCargo=" + sCargo + "&nMontoMax=" + nMontoMaximo + "&nMontoMin=" + nMontoMinimo + "&nEstado=" + nEstado;
        frm.submit();
            ...
            <tr>
                <td>
                    ...
                    <table cellSpacing="1"  border=0 width="100%">
                        <tr>
                            <td colspan=2 class="row7" style="FONT-SIZE: 10pt" align="left">
                              <label class="titulo_campos_bold"><%=strSubTitulo%>&nbsp;-&nbsp;Configuraci&oacute;n&nbsp;de&nbsp;Montos&nbsp;Alerta</label> 
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr> 
                            <td class="header" width="10%">Encargado(a)</td>
                            <td class="row1">
                        ...
                        <tr> 
                            ...
                            <td class="row1">
                                <input class="row5 input_text_sed" name = "tctCargo" type="text" maxlength="30" style="width:70%" onKeyPress="javascript:onKeyPressMayuscula.call(this, event);">
                            </td>
                        </tr>
                        <tr>
