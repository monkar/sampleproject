...
<html>
  ...
  <![endif]--> 
    <table class="2 form-table-controls" cellspacing="2" cellpadding="3" border="0" width="100%" align="left">
      <tr>      
        <td class="header" width="90%">Hist&oacute;rico de la Solicitud</td>      
        <td width="10%">
      ...
      <%
         String idSol = request.getParameter("nidSolicitud");
         String url = "../consultasolicitud/HistoricoSolicitud2.jsp?nidSolicitud="+idSol;
      %>
      <tr><td colspan="2">
        <fieldset class="row5 content_resumen">
        <legend></legend>
        <iframe name="frLstSolicitudHis" align=left width="100%" height="340" frameborder="0" scrolling="auto" src=<%=url%> ></iframe>
        </fieldset>
      </td></tr> 
    </table>  
  </body>
