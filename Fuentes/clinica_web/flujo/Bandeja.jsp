  ...
  <table width="100%" class="2 form-table-controls" cellspacing="0" cellpadding="0">
      ...
      <td>
        ...
        <tr>
            ...
            <%if (true || (usuario.getIntIdRol()!=Constante.NROLMED && usuario.getIntIdRol()!=Constante.NROLATEC)){%>
                ...
                <td align=left width="25%" class="row1" >
                    <select style="width:180px" name="lscEstado" <%=(usuario.getIntIdRol()!=Constante.NROPERFILBRK && usuario.getIntIdRol()!=Constante.NROLOPE && usuario.getIntIdRol()!=Constante.NROLENF)?"multiple class='TxtCombo lp-select-multiple'":"class='TxtCombo lp-select'"%> >
    ...
    <tr id="trBusqueda" style="display=''">
      <td>
        ...
        %>
        <!-- DQ -->
          <iframe name="frLstSolicitud" align=left width="100%" height="900px" frameborder="0" scrolling="auto" src="../flujo/ListaSolicitud.jsp?psbuscar=1&default=1"></iframe>        
        <%
         }else{
        %>  
        <!-- DQ -->
          <iframe name="frLstSolicitud" align=left width="100%" height="900px" frameborder="0" scrolling="auto" src="../flujo/ListaSolicitud.jsp?psbuscar=0&default=1"></iframe>
        <%
         }        
        %>  
        </fieldset>
