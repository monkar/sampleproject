...
<%
  ...
  String nomAsegurado = request.getParameter("tctAsegurado");
...
<table width="100%" class="2" cellspacing="0" cellpadding="0">
  ...
  <table width="100%" class="2" cellspacing="0" cellpadding="0">
    <tr>
      <td>
        ...
        <tr>
            ...
            <%if (true || (usuario.getIntIdRol()!=Constante.NROLMED && usuario.getIntIdRol()!=Constante.NROLATEC)){%>
                <td align=left class="row1"  width="15%">Estado :&nbsp;</td>
                <td align=left width="25%" class="row1" >
                    <select class="TxtCombo lp-select" style="width:180px" name="lscEstado" <%=(usuario.getIntIdRol()!=Constante.NROPERFILBRK && usuario.getIntIdRol()!=Constante.NROLOPE && usuario.getIntIdRol()!=Constante.NROLENF)?"multiple lp-select-multiple":"lp-select"%> >
            ...
            <%}else{%>
                <td align=left class="row1">
                    <input type="hidden" name="lscEstado" value="<%=Constante.NESTPEN%>"/>
                </td>
        ...
        <tr <%=((usuario.getIntIdRol()!=Constante.NROPERFILBRK && usuario.getIntIdRol()!=Constante.NROLOPE && usuario.getIntIdRol()!=Constante.NROLENF)?"":"style=\"display:none\"")%> > 
           <%
    ...
    <tr id="trBusqueda" style="display=''">
      <td>
        ...
        <legend></legend>
        <%
         if(usuario.getIntIdRol() == Constante.NROLBRK)
         {
        %>
          <iframe name="frLstSolicitud" align=left width="100%" height="900%" frameborder="0" scrolling="auto" src="../flujo/ListaSolicitud.jsp?psbuscar=1&default=1&tctAsegurado=<%=nomAsegurado%>"></iframe>        
        <%
         }else if(usuario.getIntIdRol()!=Constante.NROLOPE && usuario.getIntIdRol()!=Constante.NROLENF)
         {
        %>
          <iframe name="frLstSolicitud" align=left width="100%" height="900%" frameborder="0" scrolling="auto" src="../flujo/ListaSolicitud.jsp?psbuscar=1&default=1"></iframe>        
        <%
         }else
         {         
        %>  
          <iframe name="frLstSolicitud" align=left width="100%" height="900%" frameborder="0" scrolling="auto" src="../flujo/ListaSolicitud.jsp?psbuscar=0&default=1"></iframe>
        <%
         }        
        %>  
        </fieldset>
 ...
 <tr id="dtSolicitud"  style="display:none">
  ...
  <table cellSpacing="0" class="2" border=0 width="100%" align="left" >
    <tr >
      <td> 
        <iframe name="procsolicitud" frameborder="0" height="900%" width="100%" scrolling="auto" src="../blancos.html"></iframe>  
      </td>
    </tr>
  </table>
 </td>
