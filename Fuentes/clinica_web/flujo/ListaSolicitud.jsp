...
//-----------
    ...
    if (intFlgBuscar == 1 ){
      ...
      objLstSolicitud = gestorSolicitud.getLstSolicitudPend(intIdRol, intIdEstado,intTipoSol,
                                                                   strNroAutoriza,strAsegurado,strClinica,intCodOficina, objUsuario.getIntCodBroker(),intTipo,intIdUsuario,strEstadosCon,strOficCon);
    }
...
<form name="frmListaSolicitud" method="post">   
          <table width="100%"  class="2 table_principal gris_pares">
            <tr>
              ...
              <th width="5%" class="header" align="center">
                <P>Fecha</P>
                <P>Registro</P>
              </th>
              <th width="6%" class="header" align="center">
                <P>Tipo</P>
                <P>Solicitud</P>
              </th>
              <!-- Req 2011-0975 -->
              ...
              <th width="6%" class="header" align="center">Rol</th>
              <%}%>            
            </tr>
            ...
            <tr>              
              ...
              <%if (objUsuario.getIntIdRol()==Constante.NROLBRK){%>
              <td class="row1 <%=classLastRow %>" align="center"><%=objLstSolicitud.getBean(i).getString("SNROSINIESTRO")%></td>
              <%}else{%>              
