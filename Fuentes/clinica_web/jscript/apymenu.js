...
if(!(l1I&&ll1<6))var I111="px";
else 
var I111="";

function I111a()
{
 var sx=ll11?lIl1.scrollLeft:pageXOffset,sy=ll11?lIl1.scrollTop:pageYOffset;return[sx,sy]
};
...
function I1lla(lIl,nx,ny){with(lIl){if(I1)
{
 left=nx;top=ny;
}
else
{
 style.left=nx+I111;style.top=ny+I111;
};
};
};
...
if(ll[j]&&ll[j].l1l1l&&ll[j].lllIl)
{
 var IllI1=I1ll("apy"+j+"m0"),III=lll1a(IllI1),llI=I111a(),l=llI[0]+ll[j].left,t=llI[1]+ll[j].top;
 if(III[0]!=l||III[1]!=t)
{
 var dx=(l-III[0])/ll[j].IIIl1,dy=(t-III[1])/ll[j].IIIl1;
 if(!I1)with(Math){
 if(abs(dx)<1)dx=abs(dx)/dx;if(abs(dy)<1)dy=abs(dy)/dy;
 }
 else
 {
  if(dx>-1&&dx<0)dx=-1;
 ...
 I1lla(IllI1,III[0]+((III[0]!=l)?dx:0),III[1]+((III[1]!=t)?dy:0));l111a(ll[j])
 ;}
 ;};
 };
var crossType=1;
...
function apy_onload()
{
 lIl1=(document.compatMode=="CSS1Compat"&&!lI1I1)?document.documentElement:document.body;
 if(I1)document.layers[0].visibility="show";
 if(!(l1I&&ll1<6))
 for(var j=0;j<ll.length;++j)if(ll[j]&&!ll[j].I1I1&&ll[j].l1l1l&&ll[j].lllIl)
 {
 window.setInterval("IllIa()",20);break;
 };
 l111="";
 lIIll="";
 IIII=1;
...
var lll1=0,lII1="",l1l1=0,llI1=1,Il1I=0;

function apy_initFrame(l1llI,lIl1l,subFrameInd,view)
{
 if(I1||(l1I&&ll1<7)||(Il1&&ll1<5))
 {
  lll1=0;
  crossType=1;
 }
...
function lI1Ia()
{
 ...
 {
  I11l1=(typeof(onload)=='function')?onload:null;onload=apy_onload;
  };
  };
 var lIll1,lI1lI;
 function II1la()
 {
  if(typeof(popupMode)=="undefined"||I1)popupMode=0;
  lIll1=(absolutePos||popupMode)?"absolute":"static";
  lI1lI=(I1)?"show":((popupMode)?"hidden":"visible");
  if(typeof(pressedItem)=="undefined")pressedItem=-2;
  else 
  if(pressedItem>=0)I11I=pressedItem;
  if(I1)
  {
  ...
  if(typeof(lll1)=="undefined")lll1=0;
  if(typeof(l1l1)=="undefined")l1l1=0;
  ...
  if(typeof(cssClass)=="undefined"||I1)
  {
   cssStyle=0;cssClass="";
  };
 if(typeof(pathPrefix)=="undefined")pathPrefix="";
 if(typeof(DX)=="undefined")DX=-5;if(typeof(DY)=="undefined")DY=0;
 ...
 if(llIl&&Il1)
 {
  DX=macIEDX;DY=macIEDY;
  topDX=macIEtopDX;
  topDY=macIEtopDY;
 };
 if(typeof(saveNavigationPath)=="undefined")saveNavigationPath=(I1?0:1);
 ...
 function l1Ila()
 {
  ...
  function l11Ia(l1lII){
  for(var i=0;i<fixPrefixes.length;i++)
  if(typeof(l1lII)=='string' && l1lII.indexOf(fixPrefixes[i])==0)
  return false;
  return true;
  };
 function lI11a(pathArr){var arr=[""];for(var i=0;i<pathArr.length;i++)if(pathArr[i]&&l11Ia(pathArr[i]))arr[i]=pathPrefix+pathArr[i];return arr;};
 ...
 for(var i=0;(i<menuItems.length&&typeof(menuItems[i])!="undefined");i++){
  ...
  while(menuItems[i][0].charAt(II1l)=="|")II1l++;
 
 if(II1l>0) {
  menuItems[i][0]=menuItems[i][0].substring(II1l,menuItems[i][0].length);
  esSubMenu = true;
 }

 lI1l1=IllI(menuItems[i][7],"");
 Il11a=(lI1l1)?parseInt(lI1l1):-1;
 
 if(!cssStyle)
 {
 ll1I=I1lI("menuBorderWidth",Il11a,"submenu",menuBorderWidth);
 l11I=I1lI("menuBorderStyle",Il11a,"submenu",menuBorderStyle);
 IIIl=I1lI("menuBorderColor",Il11a,"submenu",menuBorderColor);
 IIlI=I1lI("menuBackColor",Il11a,"submenu",menuBackColor);
 IIl=I1lI("menuBackImage",Il11a,"submenu",menuBackImage);
 
 if(l11Ia(IIl))IIl=pathPrefix+IIl;
 }
 else l1111=I1lI("CSS",Il11a,"submenu",cssClass);
 II1ll=I1lI("columnPerSubmenu",Il11a,"submenu",columnPerSubmenu);
 II11l=I1lI("itemSpacing",Il11a,"submenu",itemSpacing);
 Il11l=I1lI("itemPadding",Il11a,"submenu",itemPadding);
 
 if(I1III<II1l){if(i>0)Illa="m"+II11.ll111+"i"+II11.i[Ill1].I1I1l;
 IIl1=l1IIl.IlIl.length;
 Ill1=0;l1IIl.IlIl[IIl1]={i:[],Ill:II,ll111:IIl1,id:"apy"+II+"m"+IIl1,Il:"",lIIa:null,l1ll:"apy"+II+Illa,lIIl1:II1l,I1I1a:(II1l>1)?DX:topDX,lII1a:(II1l>1)?DY:topDY,llI1I:macIEoffX,l1I1I:macIEoffY,lIIIl:0,Ill1I:0,l1Ill:ll1I,lI1I:l11I,I111l:IIIl,I1Il:i?((II1ll>1)?1:orientation):isHorizontal,l11lI:II11l,Il111:Il11l,llIl1:IIlI,lI1l:IIl,III1I:!i?100:transparency,l1lIl:!i?0:transition?transition:1,IlIa:transition?transDuration:0,IlI1I:shadowColor,I1I1I:shadowLen,l1Il1:IllI(menuWidth,"0px"),II11I:"",cssClassName:l1111,I11I1:II1ll};II11=ll[II].IlIl[IIl1];
 };
 
 if(I1III>II1l)
 {
  while(ll[II].IlIl[IIl1].lIIl1>II1l)IIl1--;II11=ll[II].IlIl[IIl1];
 };
 
  I1III=II1l;
  
  if(!statusString||statusString=="link")IIlIl=IllI(menuItems[i][1],"");
  else 
  if(statusString=="text")IIlIl=IllI(menuItems[i][0],"");
  Ill1=II11.i.length;IlllI="apy"+II+"m"+IIl1+"i"+Ill1;
  
  if(menuItems[i][0]=="-")IlllI+="sep";
  lIlI=IllI(menuItems[i][6],"");
  Il11a=(lIlI)?parseInt(lIlI):-1;icons=lI11a([IllI(menuItems[i][2],""),IllI(menuItems[i][3],"")]);
  l11ll=lI11a(I1lI("arrowImageMain",Il11a,"item",IllIl));III1l=lI11a(I1lI("arrowImageSub",Il11a,"item",I1lIl));
  lI11l=lI11a(I1lI("itemBackImage",Il11a,"item",I11Il));
  II1I1=I1lI("itemWidth",Il11a,"item",Illll);
  
  if(!cssStyle)
  {
  I1lI1=I1lI("fontColor",Il11a,"item",I1lll);
  lIlI1=I1lI("fontStyle",Il11a,"item",lIlll);
  lllI1=I1lI("fontDecoration",Il11a,"item",lllll);
  llIlI=I1lI("itemBackColor",Il11a,"item",lIIlI);
  I111I=I1lI("itemBorderColor",Il11a,"item",IIllI);
  lI11I=I1lI("itemBorderWidth",Il11a,"item",l1IlI);
  l1lI1=I1lI("itemBorderStyle",Il11a,"item",l1lll);
  }
  else IIll=I1lI("CSS",Il11a,"item",cssClass);
  ll11l=IllI(menuItems[i][5],"");
  
  if(ll11l=="_")ll11l=0;else ll11l=1;
  llI11=IllI(menuItems[i][5],"_self");
  
  if(llI11=="_self"&&itemTarget!="")
  llI11=itemTarget;
  IIll1=IllI(menuItems[i][1],"");
  
  if(IIll1&&IIll1.toLowerCase().indexOf("javascript:")!=0&&pathPrefix)IIll1=pathPrefix+IIll1;
  
  if(!II1l)itemAlign_=itemAlign;
  else itemAlign_=subMenuAlign;

  if( menuNuevaMarca ){
          if (esSubMenu){
              menuItemsNuevaMarca[indiceMenuNuevaMarca].opciones.push({id: IlllI, datos: menuItems[i]} );
          } else {
              indiceMenuNuevaMarca++;
              menuItemsNuevaMarca[indiceMenuNuevaMarca] = {
                  datos: menuItems[i],
                  opciones: [],
                  id: IlllI
              };            
...
function IIIla(){
  ...
  if(a.indexOf("Opera")>=0){
    l1I=1;
    ll1=parseFloat(a.substring(a.indexOf("Opera")+6,a.length));
  }else if(n.toLowerCase()=="netscape"){if(a.indexOf("rv:")!=-1&&a.indexOf("Gecko")!=-1&&a.indexOf("Netscape")==-1){
    lI1I1=1;
    ll1=parseFloat(a.substring(a.indexOf("rv:")+3,a.length));
  }else{
    Il11=1;
    if(a.indexOf("Gecko")!=-1&&a.indexOf("Netscape")>a.indexOf("Gecko"))
    {
      if(a.indexOf("Netscape6")>-1)ll1=parseFloat(a.substring(a.indexOf("Netscape")+10,a.length));
  
      else if(a.indexOf("Netscape")>-1)ll1=parseFloat(a.substring(a.indexOf("Netscape")+9,a.length));
  } else ll1= 11; //parseFloat(IIla);
  };
  }else if(document.all?1:0){Il1=1;ll1=parseFloat(a.substring(a.indexOf("MSIE ")+5,a.length));
};
I1=Il11&&ll1<6;l1lI=Il1&&ll1>=5;ll11=Il1||(l1I&&ll1>=7);
};

function lI1la(lI){var frm=parent.frames[lI.l1l];return(frm.document.compatMode=="CSS1Compat"&&!lI1I1)?frm.document.documentElement:frm.document.body};function ll11a(lI,q){var l=0,t=0,w=0,h=0;if(Il11||lI1I1||l1I){var IIl11=((lI&&lI.I1I1&&crossType==1)?parent.frames[lI.l1l].window:window);w=IIl11.innerWidth;h=IIl11.innerHeight;l=IIl11.pageXOffset;t=IIl11.pageYOffset;}else{var IIl11=((lI&&lI.I1I1&&crossType==1)?lI1la(lI):lIl1);l=IIl11.scrollLeft;t=IIl11.scrollTop;w=IIl11.clientWidth;h=IIl11.clientHeight;};return[l,t,w,h];};function IIl1I(o){var l=0,t=0,h=0,w=0;if(!o)return[l,t,w,h];if(l1I&&ll1<6){h=o.style.pixelHeight;w=o.style.pixelWidth;}else if(I1){h=o.clip.height;w=o.clip.width;}else{h=o.offsetHeight;w=o.offsetWidth;};var lIl=(I1)?o:o.offsetParent;while(lIl){l+=parseInt(I1?o.pageX:o.offsetLeft);t+=parseInt(I1?o.pageY:o.offsetTop);t+=(llIl&&Il1)?o.parentNode.offsetTop:0;o=o.offsetParent;lIl=(I1)?o:o.offsetParent;};return[l,t,w,h];};

function I1Ila(lI1){
var I11=I1ll(lI1.id),IlIlI=I1ll(lI1.l1ll),IlI1=IIl1I(IlIlI),I1l1l=I1ll1(lI1.l1ll),II1l=ll11a(ll[lI1.Ill]);
if(!I1){
var llllI=I1ll(I11.id+'TB'),lll11=IIl1I(llllI);
}
else var lll11=IIl1I(I11),x=0,y=0;
if(ll[I1l1l.Ill].IlIl[I1l1l.ll111].I1Il)
{
 if(Il1||Il11)
 {
  if(itemAlign=="right")x=IlI1[0]+IlI1[2]-lll11[2]-lI1.I1I1a;
  else 
  if(itemAlign=="center")x=IlI1[0]+(IlI1[2]-lll11[2])/2;
  else x=IlI1[0]+lI1.I1I1a;
 }
 else x=IlI1[0]+lI1.I1I1a;
 if(ll[lI1.Ill].ll1lI)y=IlI1[1]-lll11[3]-lI1.lII1a;
 else y=IlI1[1]+IlI1[3]+lI1.lII1a;
}
else
{
 x=lI1.I1I1a+IlI1[0]+IlI1[2];
 y=lI1.lII1a+IlI1[1];
};

II1l[2]+=II1l[0];II1l[3]+=II1l[1];

if(!ll[lI1.Ill].I1I1||(lI1.lIIl1>1&&crossType!=3))
{
 if(x+lll11[2]>II1l[2])x=II1l[2]-lll11[2];
 if(x<II1l[0])x=II1l[0];if(y+lll11[3]>II1l[3])y=II1l[3]-lll11[3];
...
function l1l1a(src,id,w,h)
{
 if(!src&&I1&&(id.indexOf("ICO")>0))
 {
  w=1;src=blankImage;
 };
 
 if(!src)return"";
 var Il1l1="<IMG SRC=\""+src+"\"";if(id)Il1l1+=" ID="+id;
 if(w!="100%")
 {
  if(w>0)Il1l1+=" WIDTH="+w;else 
  if(Il11)Il1l1+=" WIDTH=0";
 };
 if(h>0)Il1l1+=" HEIGHT="+h;
 else 
 if(Il11)Il1l1+=" HEIGHT=0";
 Il1l1+=" BORDER=0>";
 return Il1l1;
 };
 var IIIll=[['Blinds'],['Checkerboard'],['GradientWipe'],['Inset'],['Iris'],['Pixelate'],['RadialWipe'],['RandomBars'],['RandomDissolve'],['Slide'],['Spiral'],['Stretch'],['Strips'],['Wheel'],['Zigzag']];
 
 function llI1a(lla,l1a)
 {
  if(ll1<5.5)return;var sF="progid:DXImageTransform.Microsoft."+IIIll[lla-25]+'('+transOptions+',duration='+l1a+')';return sF;
 };
 function lIIla(lI1)
 {
  if(l1lI&&!llIl)
  {
   var sF="filter:";
   if(lI1.l1lIl)
   if(lI1.l1lIl==24)sF+="blendTrans(Duration="+lI1.IlIa/1000+") ";
   else 
   if(lI1.l1lIl<24)sF+="revealTrans(Transition="+lI1.l1lIl+",Duration="+lI1.IlIa/1000+") ";
   else sF+=llI1a(lI1.l1lIl,lI1.IlIa/1000);
   if(lI1.III1I)sF+="Alpha(opacity="+lI1.III1I+") ";
   if(lI1.IlI1I)sF+="Shadow(color="+lI1.IlI1I+",direction=135,strength="+lI1.I1I1I+") ";sF+=";";
   return sF;}else return"";
   };
   function Illla(n,IlIl,i)
   {
   return'apy'+n+'m'+IlIl+'i'+i+((Il11&&ll1<7)?'ITX':'ITD');
   };
   function apy_changeItemText(n,IlIl,i,text)
   {
    if(I1)return null;
    var item=I1ll(Illla(n,IlIl,i));
    item.innerHTML=text;
   };
   function apy_changeItem(n,IlIl,i,lI1ll,l1II1,lIlIl,l11I1,l1l11)
   {
   if(I1)return null;
   var item=I1ll(Illla(n,IlIl,i));
   if(lI1ll)item.innerHTML=lI1ll;
   var l1=I1ll1(item.id);
   if(l1II1)l1.lI111=l1II1;if(lIlIl)
   {
    item=I1ll('apy'+n+'m'+IlIl+'i'+i+'I');
    item.title=lIlIl;
    };
    
    if(l1l11)
    {
     l1.lI11[0]=l1l11;item=I1ll('apy'+n+'m'+IlIl+'i'+i+'ICO');
     item.src=l1l11;
    };
    
    if(l11I1)l1.lI11[1]=l11I1;
    };
    var IlI=false,Il1l=false;
    function apy_setPressedItem(n,IlIl,i,ll1ll){
    var lI=ll[n];
    if(!IlI&&lI.I1l!=-1)
    {
     IlI=true;
     with(lI)
     {
      apy_setPressedItem(n,lII,I1l,ll1ll);
      if(lII==IlIl&&I1l==i)
      {
       lII=0;I1l=-1;return;
       };
    ...
    if(!IlI)
    {
     lI.lII=IlIl;lI.I1l=i;
    }
    else IlI=false;
    var l1=I1ll1('apy'+n+'m'+IlIl+'i'+i);
    if(!Il1l)l1.lll=!l1.lll;Il1l=false;
    if(!I1)IIIa(l1,(l1.lll?1:0),l1.ll111);
    if(ll1ll&&IlIl>0)
    {
     var I11=ll[n].IlIl[IlIl];
     for(var j=I11.lIIl1;j>0;j--)
     {
      IlIlI=I1ll1(I11.l1ll);
      if(!I1)IIIa(IlIlI,(l1.lll?1:0),IlIlI.ll111);
      else 
      if(j==1)with(I1ll(IlIlI.id).document.layers[0])
      { 
       document.layers[1].visibility=(l1.lll?"show":"hide");
       document.layers[0].visibility=(l1.lll?"hide":"show");
      };
      IlIlI.lll=l1.lll;I11=ll[n].IlIl[IlIlI.ll111];
      };
      };
      };
      
      function llIla(event)
      {
       var x=0,y=0;
      if(Il1||l1I)
      {
       x=event.clientX+(ll11?lIl1.scrollLeft:0);
       y=event.clientY+(ll11?lIl1.scrollTop:0);
      }
      else
      {
     ...
     function apy_popup(IlII1,IIlI1,event,x,y)
     {
      if(Il1)event.returnValue=false;
      if(x&&y)var IlI1l=[x,y];
      else var IlI1l=llIla(event),lI=ll[IlII1],IIII1=lI.IlIl[1];
      if(IIII1)
      {
       var lIl=I1ll(IIII1.id);
       if(lIl.style.visibility=="visible")
       {
        clearTimeout(lI.lI1II);
        I1l1a(lI.IlIl[0].Il);status='';
       };
       lI.IlIl[0].Il=IIII1.id;
       I11Ia(IIII1.id);
       lIl.style.left=IlI1l[0]+I111;
       lIl.style.top=IlI1l[1]+I111;
       if(IIlI1>0)lI.lI1II=setTimeout("I1l1a('"+lI.IlIl[0].Il+"'); status='';",IIlI1);
       }
       ;return false;
     };


function renderMenuNuevaMarca()
{
    var opciones = null;
    var html = '';
    var textMenu = "";
    ...
    /*<!-- DQ -->*/
    if( isIE()){
      for (var i = 0; i < menuItemsNuevaMarca.length && typeof menuItemsNuevaMarca[i] != "undefined"; i++) {        
              textMenu = menuItemsNuevaMarca[i].datos[0];
              if( textMenu != null && textMenu != undefined && textMenu != "" ){
                  textMenu = textMenu.toUpperCase();
              }
              html+= '<div class="menuIE">';
              
              html += '<a class="enlace_menu_ie" style="color: white; font-family: Mirai_regular; font-size: 11px; letter-spacing: 0.3px;" href="#" urlmenu=\"' + menuItemsNuevaMarca[i].datos[1] + "\"";   
              html += menuItemsNuevaMarca[i].datos[0] == "-" ? ">" : "onClick='lIIIa(event,\"" +  menuItemsNuevaMarca[i].id + "I\");'>";
              html += textMenu + '</a>';
              
                opciones = menuItemsNuevaMarca[i].opciones;
                if( opciones != undefined && opciones.length > 0 ){
                    html+= '<div style="clear:both" ></div>'
                    html+= '<div class="subIE"><ul>';
                    for (var j = 0; j < opciones.length; j++) {
                        html += '<li><a class="sub_enlace" href="#" urlmenu=\"' + opciones[j].datos[1] + "\"";;  
                        html += opciones[j].datos[0] == "-" ? ">" : "onClick='lIIIa(event,\"" + opciones[j].id + "I\");'>";
                        html += opciones[j].datos[0] + '</a></li>';
                    }
                    html += '</ul></div>';
                }
        ...
        html = '<ul class="menu_sel">';
        for (var i = 0; i < menuItemsNuevaMarca.length && typeof menuItemsNuevaMarca[i] != "undefined"; i++) {        
              textMenu = menuItemsNuevaMarca[i].datos[0];
              if( textMenu != null && textMenu != undefined && textMenu != "" ){
                  textMenu = textMenu.toUpperCase();
              }
              html += '<li><a class="enlace_menu" href="#" urlmenu=\"' + menuItemsNuevaMarca[i].datos[1] + "\" ";   
              html += menuItemsNuevaMarca[i].datos[0] == "-" ? ">" : "onClick='lIIIa(event,\"" +  menuItemsNuevaMarca[i].id + "I\");'>";
              html += textMenu + '</a>';
