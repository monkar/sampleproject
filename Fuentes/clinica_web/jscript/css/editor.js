...
this.btnList = {
    ...
    "bold":           ['Bold',                 'Negrita',               'editor_action(this.id)',  'ed_format_bold.gif'],
    "italic":         ['Italic',               'Italica',             'editor_action(this.id)',  'ed_format_italic.gif'],
    "underline":      ['Underline',            'Subrayado',          'editor_action(this.id)',  'ed_format_underline.gif'],
    ...
    "justifyleft":    ['JustifyLeft',          'Alineamiento a la Izquirda',       'editor_action(this.id)',  'ed_align_left.gif'],
    "justifycenter":  ['JustifyCenter',        'Justify Center',     'editor_action(this.id)',  'ed_align_center.gif'],
    "justifyright":   ['JustifyRight',         'Alineamiento a la Derecha',      'editor_action(this.id)',  'ed_align_right.gif'],
    ...
    "outdent":        ['Outdent',              'Decrementa Indentado',    'editor_action(this.id)',  'ed_indent_less.gif'],
    "indent":         ['Indent',               'Incrementa Indentado',    'editor_action(this.id)',  'ed_indent_more.gif'],
    "forecolor":      ['ForeColor',            'Color del Texto',         'editor_action(this.id)',  'ed_color_fg.gif'],
    "backcolor":      ['BackColor',            'Color de Fondo',   'editor_action(this.id)',  'ed_color_bg.gif'],
    "horizontalrule": ['InsertHorizontalRule', 'Linea Horizontal',    'editor_action(this.id)',  'ed_hr.gif'],
    "createlink":     ['CreateLink',           'Inserta Enlace Web',    'editor_action(this.id)',  'ed_link.gif'],
    "insertimage":    ['InsertImage',          'Inserta Imagen',       'editor_action(this.id)',  'ed_image.gif'],
    "inserttable":    ['InsertTable',          'Inserta Tabla',       'editor_action(this.id)',  'insert_table.gif'],
    "htmlmode":       ['HtmlMode',             'Ver Codigo HTML',   'editor_setmode(\''+objname+'\')', 'ed_html.gif'],
    "popupeditor":    ['popupeditor',          'Agrandar Editor',     'editor_action(this.id)',  'fullscreen_maximize.gif'],
    "about":          ['about',                'Acerca del editor',  'editor_about(\''+objname+'\')',  'ed_about.gif'],
