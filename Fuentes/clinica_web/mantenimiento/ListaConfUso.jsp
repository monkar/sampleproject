...
<% 
    ...
    objList = gestorCobertura.listUsoCoberturaConfig(intPoliza);
...
<![endif]--> 
<form name="frmListaConfUso" method="post">   
            ...
            <td class="row1" width="100%" align="left" colspan="2"> 
                <table width="100%" class="2 table_principal gris_pares table_pagination"> 
                    <tr>
                        ...
                        <th class="header" align=center WIDTH=10%>Cod. Concepto Pago</th>
                        <th class="header" align=center WIDTH=30%>Desc. Concepto Pago</th>
                    </tr>
                    <%    
                    ...
                    %>
                        ...
                        <tr>
                          ...
                          <td class="row1" align="center">
                              <A class="link_acciones" href="javascript:Editar('<%=objBean.getString("NPOLIZA")%>','<%=objBean.getString("NCOBERTURA")%>','<%=objBean.getString("NCOBERTURAGEN")%>','<%=objBean.getString("NCONCEPTOPAGO")%>');">
                          ...
                          <td class="row1" align="left"><%=objBean.getString("SDESCOVER")%></td>
                          <td class="row1" align="center"><%=objBean.getString("NCONCEPTOPAGO")%></td>
                          <td class="row1 tr-td-last-child" align="left"><%=(objBean.getString("NCONCEPTOPAGO").equals("0")==false?objBean.getString("SDESCONPAGO"):"Todos")%></td>
                        </tr>
                    <%  
                        }
                    %>
...
<script type="text/javascript">
  ...
  {
      parent.Editar(policy , cover, covergen, payconcep); 
  }
