...
<html>
    <head>
    <title>MANTENIMIENTO DE OPCION POR COBERTURA</title>
    ...
    <script type="text/javascript">
        ...
        {        
            ...
            frm.target="frmLstConfControl";
            accion = "ListaConfControl.jsp?flgBuscar=1&tcnpoliza=" + poliza;        
            if (pagina != undefined)
        ...
        { 
           var frm = document.forms[0]; 
           alert(policy+" - "+cover+" - "+covergen);
           frm.target = "_self";
           frm.action = "MantenimientoControl_Editar.jsp?ncover=" + cover + "&npolicy=" + policy + "&ncovergen=" + covergen;
           frm.submit();
        ...
        <table width="100%" class="2 form-table-controls" cellspacing="0" cellpadding="0">
                        ...
                        <table cellSpacing="1" border=0 width="100%">
                            <tr>
                                <td class="row5" style="FONT-SIZE: 10pt" align="left" colspan="4" >
                                    <label class="titulo_campos_bold">Configuraci&oacute;n de Control por Contrato - Listado</label>                                     
                                </td>
                            </tr>
            ...
            <tr id="trBusqueda" style="display:none">
                <td>
                    ...
                    <fieldset class="row5 content_resumen">
                    <legend></legend>  
                        <iframe name="frmLstConfControl" align=left width="100%" height="700" frameborder="0" scrolling="auto" src="ListaConfControl.jsp"></iframe>
                    </fieldset>
                    </div>
                </td>
            </tr>
