...
<form name="frmAtencion" method="post">
 ...
 <td>
  <table cellSpacing="0" class="2 form-table-controls" border=0 width="100%" align="left" >
    <tr >
      <td>
        <table width="100%" cellspacing="0" cellpadding="0" class="form-table-controls">
        <tr>
          <!--<td class="row2" width="25%" align=left><b>Consulta de Asegurados</b></td>-->
          <td width="75%">
            <fieldset class="row5 content_resumen" style="padding-top:1px; padding-bottom:5px">
            <legend class="titulo_campos_bold">Búsqueda</legend>  
                                        ...
                                        <table cellSpacing="1"  border=0 width="100%">                                  
                                          <tr id="trBuscarClinica" >
                                              <td>
                                                  ...
                                                  <input type="button" class="TxtCombob" value="Buscar Clínica    " onclick="javascript:onClickCargarPagina();"/>                                              
                                              </td>
                                          </tr>
                                        </table>                                  
                                  </td>                                                                       
    ...
    <tr>
      <td>
        <fieldset class="row5 content_resumen"  style="padding-top:8px; padding-bottom:5px">
          <table cellSpacing="1" border="0" width="100%" class="form-table-controls">
            <tr id="trNombre">
              <td align="left" class="row1" width="20%" >Apellidos del Asegurado&nbsp;:&nbsp;</td>
              <td align="left" colspan=4 class="row4">
              <input class="row5 input_text_sed" name="tctNombre" type="text" style="width:100%" value="" onKeyPress="javascript:onKeyPressMayuscula.call(this, event);onKey(this);"/></td>
              ...
              <td>
                <table cellSpacing="1" border="0" width="100%" class="form-table-controls">
                  ...
                  <tr>
                      ...
                      <td align="left" class="row1" width="20%">
                        <input class="row1 input_text_sed" name= "tctCodCliente" class="row1" type="text" readonly value="" onKeyPress="javascript:onKeyPressNumero('this');"/>
                      </td>
                      <td align="left" class="row1" width="20%">
    ...
    <tr id="trBusqueda">
      <td>
        <fieldset class="row5 content_resumen"  style="padding-top:5px; padding-bottom:5px ;  ">
        <legend class="titulo_campos_bold">
          Resultado de Búsqueda
        </legend>  
          <iframe name="frListaCliente" align=left width="100%" height="300" frameborder="0" scrolling="auto" src="../notifica/ListaCliente.jsp"></iframe>          
          <!--Tiempo que ha tardado la página en cargarse: <span id="tmp">Calculando...</span> segundos.-->
        </fieldset>
    ...
    <tr id="trDetalle" style="display:none">
      <td>
        ...
        <legend class="titulo_campos_bold">
          ...
          <iframe name="frDetalleCliente" align=left width="100%" height="200" frameborder="0" scrolling="auto" src="../notifica/DetalleCliente.jsp"></iframe>
        </fieldset>
...
<script type="text/javascript">
 function LoadBody()
 {
  ...
  function verListado(){
      ...
      frListaCliente.location.href = "../notifica/ListaCliente.jsp";
  }

  function verAlerta(code){
    if (code == 0)
      alert("El correo del Asegurado fue actualizado correctamente.");  
    else
    if (code == -1)
      alert("Ocurrió un error al intentar actualizar el correo.");  
    else
  ...
  function verDetalle(){
      ...
      frDetalleCliente.location.href = "../notifica/DetalleCliente.jsp?codStrCliente="+codCliente; 
      trBusqueda.style.display = 'none';
